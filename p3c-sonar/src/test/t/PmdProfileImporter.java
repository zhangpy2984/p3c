...
public class PmdProfileImporter extends ProfileImporter {
    ...
    protected RulesProfile createRuleProfile(PmdRuleset pmdRuleset, ValidationMessages messages) {
        ...
        for (PmdRule pmdRule : pmdRuleset.getPmdRules()) {
            ...
            if (CustomRulesDefinition.XPATH_CLASS.equals(ruleClassName)) {
                ...
                if (ruleRef == null) {
                    ...
                    Rule rule = ruleFinder.find(RuleQuery.create().withRepositoryKey(CustomRulesDefinition.REPOSITORY_KEY).withConfigKey(ruleRef));
                    if (rule != null) {
